...
namespace DataManager.Core
{
    ...
    /// </summary>
    public class Manager : Interfaces.IEntityGateway, IDisposable
    {
        class CountableItem{
            object _item = null;
        ...
        public Manager(string connectionStr, string model, string provider = "System.Data.SqlClient") {
        ...
        public Manager(string connectionStr, string model, TimeSpan maxWait, string provider = "System.Data.SqlClient")
        {
            _maxWait = maxWait;
        ...
        /// <returns></returns>
        public IEntityOperations<TEntity> Get<TEntity>() where TEntity:class {
            IEntityOperations<TEntity> ret = null;
            ...
            lock(_mapLock) {
                ...
                ret = _map[key].Object as IEntityOperations<TEntity>;
            }
            return ret;
        }
